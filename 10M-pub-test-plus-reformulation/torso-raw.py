...
#SBATCH --job-name=10M-pub-test-torso-raw    # Name of the job
...
doc_encoder_path = r"../../trained_model_initial_PubMed_all/doc_encoder"
query_encoder_path = r"../../trained_model_initial_PubMed_all/query_encoder"
