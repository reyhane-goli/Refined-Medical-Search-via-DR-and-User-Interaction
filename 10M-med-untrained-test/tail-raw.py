...
#SBATCH --job-name=10M-untrained-med-test-tail-raw    # Name of the job
...
doc_encoder_path = "ncbi/MedCPT-Article-Encoder"
query_encoder_path = "ncbi/MedCPT-Query-Encoder"
