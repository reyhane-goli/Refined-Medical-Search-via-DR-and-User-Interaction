...
#SBATCH --job-name=10M-untrained-pub-test-head-dctr    # Name of the job
...
# torch.save(query_embeddings, 'query_embeddings_10M_pubmed.pt')
...
# torch.save(document_embeddings, 'document_embeddings_10M_pubmed.pt')
