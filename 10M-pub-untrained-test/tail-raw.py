...
#SBATCH --job-name=10M-untrained-pub-test-tail-raw    # Name of the job
...
doc_encoder_path = "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext"
query_encoder_path = "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext"

# Load the document encoder
doc_tokenizer = AutoTokenizer.from_pretrained("microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext")
doc_encoder = AutoModel.from_pretrained(doc_encoder_path)

# Load the query encoder
query_tokenizer = AutoTokenizer.from_pretrained("microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext")
...
# load the model
query_embeddings = torch.load('query_embeddings_10M_pubmed.pt')
...
document_embeddings = torch.load('document_embeddings_10M_pubmed.pt')
