...
#SBATCH --job-name=10M-med-reformulation-test-tail-raw    # Name of the job
...
# Save the dictionary to a file
with open(r'resultsdf_LAplusReformulation_test_tail', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")
...
with open(r'resultsdf_DRplusLAplusReformulation_test_tail', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")
