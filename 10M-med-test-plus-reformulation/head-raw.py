...
#SBATCH --job-name=10M-med-reformulate-test-head-raw    # Name of the job
...
# Load the dictionary from the file
# with open(r'resultsdf_LAplusReformulation_test_head', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
...
# #Load the dictionary from the file
# with open(r'resultsdf_DRplusLAplusReformulation_test_head', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
