...
#SBATCH --job-name=5M-pub-valid-head-dctr    # Name of the job
...
### head queries --> validation
new_query_text = head_queries_val_df['qtext'].tolist()
new_query_ids = head_queries_val_df['qid'].tolist()
print("head_queries_test_df.shape[0]", head_queries_val_df.shape[0])
...
with open(r'resultsdf_DR_val_head', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")


# Load the dictionary from the file
# with open(r'resultsdf_DR_val_head', 'rb') as file:
...
for new_qid in new_query_ids:
    ...
    for doc_id in top_1000_docs:
        if doc_id in dctr_head_queries_val_df['docid'].values:
            qrel_value = dctr_head_queries_val_df[(dctr_head_queries_val_df['qid'] == new_qid) & 
                                                           (dctr_head_queries_val_df['docid'] == doc_id)]['qrel'].values
    ...
    ### test queries
    relevant_docs = dctr_head_queries_val_df[(dctr_head_queries_val_df['qid'] == new_qid) & (dctr_head_queries_val_df['qrel'] != 0)]
...
# Save the dictionary to a file
with open(r'resultsdf_LA_val_head', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")

# Load the dictionary from the file
# with open(r'resultsdf_LA_val_head', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
...
with open(r'resultsdf_DRplusLA_val_head', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")

# Load the dictionary from the file
# with open(r'resultsdf_DRplusLA_val_head', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
