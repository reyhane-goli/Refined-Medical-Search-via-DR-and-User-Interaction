...
#SBATCH --job-name=5M-pub-val-torso-raw    # Name of the job
...
new_query_text = torso_queries_val_df['qtext'].tolist()
new_query_ids = torso_queries_val_df['qid'].tolist()
print("torso_queries_test_df.shape[0]", torso_queries_val_df.shape[0])
...
with open(r'resultsdf_DR_val_torso', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")


# Load the dictionary from the file
# with open(r'resultsdf_DR_val_torso', 'rb') as file:
...
for new_qid in new_query_ids:
    ...
    for doc_id in top_1000_docs:
        if doc_id in raw_torso_queries_val_df['docid'].values:
            qrel_value = raw_torso_queries_val_df[(raw_torso_queries_val_df['qid'] == new_qid) & 
                                                           (raw_torso_queries_val_df['docid'] == doc_id)]['qrel'].values
    ...
    ### test queries
    relevant_docs = raw_torso_queries_val_df[(raw_torso_queries_val_df['qid'] == new_qid) & (raw_torso_queries_val_df['qrel'] != 0)]
...
# Save the dictionary to a file
with open(r'resultsdf_LA_val_torso', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")

# Load the dictionary from the file
# with open(r'resultsdf_LA_val_torso', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
...
with open(r'resultsdf_DRplusLA_val_torso', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")

# Load the dictionary from the file
# with open(r'resultsdf_DRplusLA_val_torso', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
