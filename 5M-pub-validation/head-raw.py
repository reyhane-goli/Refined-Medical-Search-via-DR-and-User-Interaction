...
#SBATCH --job-name=5M-pub-val-head-raw    # Name of the job
...
for new_qid in new_query_ids:
    ...
    for doc_id in top_1000_docs:
        if doc_id in raw_head_queries_val_df['docid'].values:
            qrel_value = raw_head_queries_val_df[(raw_head_queries_val_df['qid'] == new_qid) & 
                                                           (raw_head_queries_val_df['docid'] == doc_id)]['qrel'].values
    ...
    ### test queries
    relevant_docs = raw_head_queries_val_df[(raw_head_queries_val_df['qid'] == new_qid) & (raw_head_queries_val_df['qrel'] != 0)]
