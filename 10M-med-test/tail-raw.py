...
#SBATCH --job-name=10M-med-test-tail-raw    # Name of the job
#SBATCH --output=tail-raw.out    # Standard output log file
#SBATCH --error=tail-raw.err     # Standard error log file
...
sys.stdout = open("tail-raw.txt", "w")
...
new_query_text = tail_queries_test_df['qtext'].tolist()
new_query_ids = tail_queries_test_df['qid'].tolist()
print("tail_queries_test_df.shape[0]", tail_queries_test_df.shape[0])
...
with open(r'resultsdf_DR_test_tail', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")


# Load the dictionary from the file
# with open(r'resultsdf_DR_test_tail', 'rb') as file:
...
for new_qid in new_query_ids:
    ...
    for doc_id in top_1000_docs:
        if doc_id in raw_tail_queries_test_df['docid'].values:
            qrel_value = raw_tail_queries_test_df[(raw_tail_queries_test_df['qid'] == new_qid) & 
                                                           (raw_tail_queries_test_df['docid'] == doc_id)]['qrel'].values
    ...
    ### test queries
    relevant_docs = raw_tail_queries_test_df[(raw_tail_queries_test_df['qid'] == new_qid) & (raw_tail_queries_test_df['qrel'] != 0)]
...
# # Save the dictionary to a file
# with open(r'resultsdf_LA_test_tail', 'wb') as file:
#     pickle.dump(results_df_dict, file)
# print("Dictionary saved successfully.")

# # Load the dictionary from the file
# # with open(r'resultsdf_LA_test_tail', 'rb') as file:
# #     results_df_dict = pickle.load(file)
# # print("Dictionary loaded successfully.")
...
with open(r'resultsdf_DRplusLA_test_tail', 'wb') as file:
    pickle.dump(results_df_dict, file)
print("Dictionary saved successfully.")

# Load the dictionary from the file
# with open(r'resultsdf_DRplusLA_test_tail', 'rb') as file:
#     results_df_dict = pickle.load(file)
# print("Dictionary loaded successfully.")
